...
types = c("I", "Y", "X","E");
min_graph=250 # need to have this as a variable that can be passed to the script
scaling_factor=100
bin_size=0.0001
title_font=7
decimal_points=4
...
for (t in 1:4) {
  ...
  filename_degrees <- paste(analysisdir, "/", basename(filename) , "_",type,"_degrees.txt", sep="");
