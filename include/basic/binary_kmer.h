...
Nucleotide binary_kmer_get_base_at_possition(BinaryKmer * bkmer, short possition);
...
int get_sliding_windows_from_sequence_with_quality(char * seq,  char * qualities, int length, char quality_cut_off, short kmer_size, KmerSlidingWindowSet * windows, int max_windows, int max_kmers);
